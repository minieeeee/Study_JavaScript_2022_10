/**
 * DOM: Documnet Object Model,html 화면에 있는 모든 요소(tag)
 * DOMcontent: 화면에 보이는 모든 것
 * DOMContentLoaded: 화면에 모든 요소가 그려지면..
 */
document.addEventListener("DOMContentLoaded", () => {
    const btnRe = document.querySelector("div.btn_re")
    // span의 개수가 많아서, class를 모두 붙이기가 번거롭다
    // 부모 div에 class를 지정하고 div span 형식으로
    // span tag를 가져온다
    ...
    btnRe?.addEventListener("click", () => {
        ...
        /**
         * Math.random() 함수는
         * 0.000 ~ 0.9999999999999 까지 범위에서
         * 임의 숫자 1개를 만들어 내는 기능
         * 
         * 생성된 숫자에 10을 곱하면
         * 0 ~ 9.9999999 범위의 수가 만들어 진다
         * 
         * 이 숫자를 Math.floor() 함수에 전달하면
         * 0 ~ 9까지 범위의 정수를 만들어서 return
         */
        const rndNum = Maht.floor(Math.random()*10)
        console.log(rndNum)
        ...
        /**
         * 1 ~ 45까지 숫자가 저장된 nums 배열을 suffle 해보자
         */
