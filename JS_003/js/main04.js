 ...
 * querySelectorAll()을 사용하여 tag들이나 class로 설정된 항목을
...
// nums[0] : nums 배열의 0 번째에 저장된 값이라는 표현
...
const strs = ["우리나라", "대한민국", "Republic of Kroea"];
// 0번 요소에 저장된 값을 읽어오기
...
// strs 배열은 const로 선언되어 있기 때문에 배열에 어떤 값을
// 직접 대입, 저장할 수 없다
// strs = "우리나라만세";
...
document.write(strs.length);
document.write("<br/>");
// strs[ strs.length - 1] : strs 베열의 마지막 요소를 가리킨다
